...
import {realtimeDashboardCollectionProd} from './configuration-realtime-dashboard-prod.model';
import {realtimeDashboardCollection} from './configuration-realtime-dashboard.model';
...
export class ConfigurationService {
    ...
    defaultBoard: any;
    realtimeDashboardCollection: any;
    realtimeDashboardCollectionProd:any;
    ...
    constructor(private _http: HttpClient) {
        ...
        Object.assign(this, {realtimeDashboardCollection});
        Object.assign(this, {realtimeDashboardCollectionProd});
        this.env = environment;
        this.seedLocalStorageWithRealtimeDashboardCollection();
    }

    private seedLocalStorageWithRealtimeDashboardCollection() {
        ...
        if (localStorage.getItem('board') === null) {
            ...
            if (this.env.production == true) {
                ...
                localStorage.setItem('board', JSON.stringify(this.realtimeDashboardCollectionProd));
            } else {
                localStorage.setItem('board', JSON.stringify(this.realtimeDashboardCollection));
            }
        }
    }
